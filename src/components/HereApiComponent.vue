...
export default {
  name: 'MapComponent',
  mounted() {
    // Carregar scripts externos dinamicamente
    const scripts = [
      "https://api.tomtom.com/maps-sdk-for-web/cdn/plugins/SearchBox/3.2.0/SearchBox-web.js",
      "https://api.tomtom.com/maps-sdk-for-web/cdn/6.x/6.25.1/maps/maps-web.min.js",
      "https://api.tomtom.com/maps-sdk-for-web/cdn/6.x/6.25.1/services/services-web.min.js",
      "https://api.tomtom.com/maps-sdk-for-web/6.x/6.25.1/examples/pages/examples/assets/js/mobile-or-tablet.js",
      "https://api.tomtom.com/maps-sdk-for-web/6.x/6.25.1/examples/pages/examples/assets/js/info-hint.js",
      "https://api.tomtom.com/maps-sdk-for-web/6.x/6.25.1/examples/pages/examples/assets/js/search/searchbox-enter-submit.js",
      "https://api.tomtom.com/maps-sdk-for-web/6.x/6.25.1/examples/pages/examples/assets/js/foldable.js"
    ];
    ...
    scripts.forEach(src => {
      ...
      script.src = src;
      script.defer = true;
      script.onload = this.initializeMap; // Initialize the map after scripts are loaded
      document.head.appendChild(script);
    });
  },
  methods: {
    initializeMap() {
      if (typeof tt === 'undefined' || typeof tt.map === 'undefined') {
